                        ...
                        <tbody>
                          @foreach ($questions as $key=>$question)
                              <tr>
                                  ...
                                  <td>
                                      <a href="{{ url('teacher/update_question/'. $question['id'])}}" class="btn btn-primary btn-sm">Update</a>
                                      <a href="{{ url('teacher/delete_question/'. $question['id'])}}" class="btn btn-danger btn-sm">Delete</a>
                                  </td>
                              </tr>
                          @endforeach
                        </tbody>
    ...
    <div class="modal-dialog modal-lg">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="{{ url('/teacher/add_new_question')}}" class="database_operation">
                <div class="row">
                    <div class="col-sm-12">
