                          ...
                          @foreach ($students as $key=>$std)
                              <tr>
                                  ...
                                  <td>
                                    ...
                                    ?>
                                          <a href="{{url('teacher/teacher_view_result/'.$std['id'])}}" class="btn btn-info btn-sm">View result</a>
                                    <?php
                                    }
                                    ?>
                                  ...
                                  <td>
                                      {{-- <a href="{{url('teacher/edit_students/'.$std['id'])}}" class="btn btn-primary">Edit</a> --}}
                                      <a href="{{url('teacher/delete_students/'.$std['id'])}}" class="btn btn-danger btn-sm">Delete</a>
                                  </td>
                              </tr>
                          @endforeach
                        </tbody>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="{{ url('teacher/add_new_students')}}" class="database_operation">
                <div class="row">
                    <div class="col-sm-12">
