      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <!-- Add icons to the links using the .nav-icon class
            ...
            <li class="nav-item">
                <a href="{{ url('teacher/exam_category')}}" class="nav-link">
            ...
            <li class="nav-item">
              <a href="{{ url('teacher/manage_exam')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Manage Exam</p>
              </a>
          </li>
          ...
          <li class="nav-item">
            <a href="{{ url('teacher/manage_students')}}" class="nav-link">
                <i class="far fa-circle nav-icon"></i>
                <p>Students</p>
            </a>
        </li>
        <li class="nav-item">
          <a href="{{ url('teacher/registered_students')}}" class="nav-link">
              <i class="far fa-circle nav-icon"></i>
