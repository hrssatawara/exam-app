            ...
            <div class="collapse navbar-collapse navbar-menu-wrapper" id="navbarSupportedContent">
                <ul class="navbar-nav align-items-lg-center align-items-start ml-auto">
                    ...
                    <li class="nav-item btn-contact-us pl-4 pl-lg-0">
                        <a href="{{ url('/teacher/login') }}"  class="btn btn-info" data-toggle="modal" data-target="#exampleModal">Teacher Login</a>
                    </li>
                </ul>
            </div>
        </div>
...
<div class="banner" >
    <div class="container">
        <h1 class="font-weight-semibold">Welcome to online exam application</h1>
