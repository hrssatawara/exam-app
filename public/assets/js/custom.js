...
$(document).on('click','.category_status',function(){
    var id=$(this).attr('data-id');
    $.get(BASE_URL+'/teacher/category_status/'+id,function(fb){
...
$(document).on('click','.student_status',function(){
    var id=$(this).attr('data-id');
    $.get(BASE_URL+'/teacher/student_status/'+id,function(fb){
        alert("status successsfully changed");
    })
})
...
$(document).on('click','.portal_status',function(){
    var id=$(this).attr('data-id');
    $.get(BASE_URL+'/teacher/portal_status/'+id,function(fb){
        alert("status successsfully changed");
    })
})
...
$(document).on('click','.question_status',function(){
    var id=$(this).attr('data-id');
    $.get(BASE_URL+'/teacher/question_status/'+id,function(fb){
        alert("status successsfully changed");
    })
})
